...
cn: {
    translation: {
      ...
      "Please login to create a new post": "请登录后创建新房源",

      "NOT AUTHORIZED": "未授权",
      "Sorry, you're not an admin": "骚凹瑞，您不是管理员",
      "Anaylysis": "分析",
      "User": "用户",
      "Search": "查询",
      "Edit": "编辑",
      "Search by post ID": "根据ID查询",
      "Search by user ID or username": "根据用户ID或用户名查询",
      "Username": "用户名",
      "Days before today": "今日之前",
      "Amount": "数量",
      "DailyPosts": "每日内容",
      "No result": "没有结果",
      "Admin actions": "管理员操作",
